...
extern  uint8_t master1_jpg_start[] asm("_binary_master1_jpg_start");
extern  uint8_t master1_jpg_end[]   asm("_binary_master1_jpg_end");

// extern  uint8_t master1_bmp_start[] asm("_binary_master1_bmp_start");
// extern  uint8_t master1_bmp_end[]   asm("_binary_master1_bmp_end");



// extern  uint8_t SD1_bmp_start[] asm("_binary_SD1_bmp_start");
// extern  uint8_t SD1_bmp_end[]   asm("_binary_SD1_bmp_end");

// extern  uint8_t BT1_bmp_start[] asm("_binary_BT1_bmp_start");
// extern  uint8_t BT1_bmp_end[]   asm("_binary_BT1_bmp_end");

// extern  uint8_t SP1_bmp_start[] asm("_binary_SP1_bmp_start");
// extern  uint8_t SP1_bmp_end[]   asm("_binary_SP1_bmp_end");



// extern  uint8_t SD2_bmp_start[] asm("_binary_SD2_bmp_start");
// extern  uint8_t SD2_bmp_end[]   asm("_binary_SD2_bmp_end");

// extern  uint8_t BT2_bmp_start[] asm("_binary_BT2_bmp_start");
// extern  uint8_t BT2_bmp_end[]   asm("_binary_BT2_bmp_end");

// extern  uint8_t SP2_bmp_start[] asm("_binary_SP2_bmp_start");
// extern  uint8_t SP2_bmp_end[]   asm("_binary_SP2_bmp_end");



extern  uint8_t SD1_jpg_start[] asm("_binary_SD1_jpg_start");
extern  uint8_t SD1_jpg_end[]   asm("_binary_SD1_jpg_end");

extern  uint8_t BT1_jpg_start[] asm("_binary_BT1_jpg_start");
extern  uint8_t BT1_jpg_end[]   asm("_binary_BT1_jpg_end");

extern  uint8_t SP1_jpg_start[] asm("_binary_SP1_jpg_start");
extern  uint8_t SP1_jpg_end[]   asm("_binary_SP1_jpg_end");


extern  uint8_t SD2_jpg_start[] asm("_binary_SD2_jpg_start");
extern  uint8_t SD2_jpg_end[]   asm("_binary_SD2_jpg_end");

extern  uint8_t BT2_jpg_start[] asm("_binary_BT2_jpg_start");
extern  uint8_t BT2_jpg_end[]   asm("_binary_BT2_jpg_end");

extern  uint8_t SP2_jpg_start[] asm("_binary_SP2_jpg_start");
extern  uint8_t SP2_jpg_end[]   asm("_binary_SP2_jpg_end");


extern  uint8_t SDW_jpg_start[] asm("_binary_SDW_jpg_start");
extern  uint8_t SDW_jpg_end[]   asm("_binary_SDW_jpg_end");

extern  uint8_t BTW_jpg_start[] asm("_binary_BTW_jpg_start");
extern  uint8_t BTW_jpg_end[]   asm("_binary_BTW_jpg_end");

extern  uint8_t SPW_jpg_start[] asm("_binary_SPW_jpg_start");
extern  uint8_t SPW_jpg_end[]   asm("_binary_SPW_jpg_end");
...
extern  uint8_t SDL_jpg_start[] asm("_binary_SDL_jpg_start");
extern  uint8_t SDL_jpg_end[]   asm("_binary_SDL_jpg_end");

extern  uint8_t SDU_jpg_start[] asm("_binary_SDU_jpg_start");
extern  uint8_t SDU_jpg_end[]   asm("_binary_SDU_jpg_end");

extern  uint8_t SPL_jpg_start[] asm("_binary_SPL_jpg_start");
extern  uint8_t SPL_jpg_end[]   asm("_binary_SPL_jpg_end");
